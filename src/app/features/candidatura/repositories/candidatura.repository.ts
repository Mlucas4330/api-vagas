...
export class CandidaturaRepository {
    ...
    // Listar vagas aplicadas pelo candidato
    public async find(idCandidato: string) {
        const candidato = await this.repository.findBy({idCandidato});
        console.log(idCandidato);

        return candidato.map(item => {
    ...
    public async delete(idRecrutador: string) {
